					...
					<div className="card">
						<div className="card-header">
							...
							<div className="dropdown">
								<button className="dropdown-toggle btn btn-link" type="button" data-toggle="dropdown" />
						...
						<div className="card-body">
							...
							<p className="card-text">
								Preparar el suelo antes de sembrar tu huerta permitira una siembra eficiente. Quitar la
								maleza, allanar y abonar son los pasos basicos para iniciar a plantar. #hortalizas
